...
<td><img src="/Sams/jsp/search/images/<%=program.getImg1()%>"  width="165" height="80">
</img>
</td>
<td>
<img src="/Sams/jsp/search/images/<%=program.getImg2()%>"  width="165" height="80">
</img>
</td>
<td><img src="/Sams/jsp/search/images/<%=program.getImg3()%>" width="160" height="80">
</img>
</td>
</tr></table>
</div>
...
<div class="crossimage">
    ...
    <table align="center" valign="bottom" width="70%" height="70%">
       <tr><td> <img src="/Sams/jsp/search/images/ppl2.jpg" width="200">
        </img>
       </td></tr>
    </table>
