...
<html>
   ...
   <script>
      ...
      function populateCountry() {
         ...
         //session.setAttribute("programbean", programbean);
               ...
               <form name="programForm" action="updateProgram" method="POST">
                  ...
                  <table width="100%" border="0" cellspacing="5" name="formTable">
                     ...
                     <tr>
                        ...
                        <td>
                           <input type="text" name="programName" style="width:180px" value="<%=programbean.getProgramName()%>" disabled />
                        </td>
                     </tr>
                     <tr>
                        <td width="50%" class="formtable" valign="top">Program Type : </td>
                        <td>
                           <span class="previousvalues"><%=programbean.getProgramType()%></span>
                           <br>
                           <select name="programType" style="width:180px">
                     ...
                     <tr>
                        ...
                        <td>
                           <input type="text" name="programName" style="width:180px" value="<%=programbean.getTerm()%>" disabled />
                           <br>
                           <input type="hidden" style="width:180px" name="term" value="<%=programbean.getTerm()%>">
                        </td>
                     </tr>
                     <tr>
                        <td width="50%" valign="top" class="formtable">Languages:</td>
                        <td>
                           <span class="previousvalues"><%for(int i=0;i<programbean.getLanguages().length;i++){%><%=programbean.getLanguages()[i]%>&nbsp;<%}%></span>
                           <br>
                     ...
                     <tr>
                        ...
                        <td>
                           <span class="previousvalues"><%=programbean.getRegion()%></span>
                           <br>
                           <select id="regionSelect" name="region" style="width:180px" onchange="updateCountry()">
                     ...
                     <tr>
                        <td></td>
                        <td>
                           <!--<input type="text" name="otherRegion" value="" />-->
                        </td>
                     </tr>
                     <tr>
                        <td width="50%" class="formtable" valign="top">Country : </td>
                        <td><span class="previousvalues"><%=programbean.getCountry()%></span>
                           <br>
                           <select id="countrySelect" style="width:180px" name="country"></select>
                        </td>
                     </tr>
                     <tr>
                        <td></td>
                        <td>
                           <!--<input type="text" name="otherCountry" value="" />-->
                        </td>
                     </tr>
                     <tr>
                        <td width="50%" class="formtable" valign="top">School/College :</td>
                        <td width="50%" class="formtable" valign="top">Subjects :</td>
                     </tr>
                     <tr>
                        <td>
                           <select id="schoolSelect" name="school" style="width:180px" onchange="updateDepartment()" multiple size="10">
                        ...
                        <td align="left">
                           <table border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                 <td align="left">
                                    <select id="departmentSelect" name="sub" style="width:80px" multiple size=10></select>
                                 </td>
                                 <td valign="middle">
                                    <input type="button" value=">>" name="right" onClick="javascript:addToDepartmentList();">
                                    <br>
                                    <br>
                                    <input type="button" value="<<" name="left" onClick="javascript:deleteFromDeptList();">
                                 </td>
                                 <td>
                                    <select style="width:80px" id="departmentList" name="subjects" multiple size=10>
                                       <%for(int i=0;i<programbean.getSubjects().length;i++){%>
                                       <option value="<%=programbean.getSubjects()[i]%>">
                                          <%=programbean.getSubjects()[i]%>
                                       </option>
                                       <%}%>
                                    </select>
                                 </td>
                     ...
                     <tr>
                        ...
                        <td>
                           <textarea cols="21" rows="10" style="width:180px" name="description">
                     ...
                     <tr>
                        ...
                        <td>
                           <textarea name="fee" rows="7" style="width:180px">
                           <%=programbean.getFee()%>
                           </textarea>
                        </td>
                     </tr>
                     <tr>
                        ...
                        <td>
                           <textarea cols="21" rows="10" style="width:180px" name="housing">
                     ...
                     <tr>
                        ...
                        <td>
                           <span class="previousvalues"><%=programbean.getStatus()%></span>
                           <br>
                           <select name="status">
                     ...
                     <tr>
                        <td colspan="3" height="26" align="center">
                           <input type="button" value="submit" onclick="javacript:submitForm();">
