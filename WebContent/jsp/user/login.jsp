                                ...
                                <table width="200" border="0" cellpadding="5" cellspacing="0" bordercolor="#666666">
                                    ...
                                    <tr bordercolor="#ffffff">
                                        <td colspan="3" align="center">
                                            <input type="submit" class="buttonclass" name="login" value="Login"> &nbsp;
                                    ...
                                    <tr>
                                        <td><a style="position: relative; left: 10vh;" class="textlink" href="forgot_password">Forgot Password</a></td>
                                    </tr>
                                </table>
                            </form>
                        </td>
