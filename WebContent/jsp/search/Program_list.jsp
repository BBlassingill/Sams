...
<table width="100%" border="0" cellspacing="5" name="formTable">
    <tr><td colspan="6" class="style1" align="center" valign="middle">Search Results</td></tr>
    <tr>
...
<tr valign="top"><td ><a href="<%=contextpath%>jsp/search/template.jsp?program_name=<%=program.getProgramName()%>&term=<%=program.getTerm()%>" TARGET=_BLANK
><%=program.getProgramName()%></a></td>
...
%>
  ...
  <table>
  <tr><td colspan="4" class="tablerows">Some Exception Occured. No data is presently available to present</td></tr>
  </table>
<%
   }
