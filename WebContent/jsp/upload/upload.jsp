...
<%@ page import="uta.sams.beans.UserBean,uta.sams.controller.UserController,java.util.ArrayList"%>
<%@ page import = "java.lang.reflect.*" %>

<jsp:useBean id="userbean" scope="request" class="uta.sams.beans.UserBean" />
...
<form onSubmit="return confirm('Are you sure you want to upload the file\nThis will change the Database?')" action="<%=request.getContextPath()%>/jsp/upload/uploadAction.jsp" enctype="multipart/form-data" method="post">    
    ...
    <table width="100%">
       ...
       <tr >
        ...
        <td width="91" bgcolor="#FFFFFF" align="right"><span class="style1"><a href="/Sams/jsp/user/logoff.jsp">Sign Out </a></span></td>
      </tr>
	  <tr>
