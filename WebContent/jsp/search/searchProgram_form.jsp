...
<%@page import="uta.sams.controller.ProgramController,uta.sams.beans.*"%><%@page contentType="text/html"%>
<%--
...
-->
    ...
    <table class="formtable" valign="top" cellpadding="0"align="center" cellspacing="0" width='759'>
    <tr><td>
 ...
 <form action="<%=request.getContextPath()%>/jsp/search/Program_list.jsp" method="post">   
   <table cellpadding="2" cellspacing="0">
            <tr><td colspan="3" ><P> <img src="<%=request.getContextPath()%>/jsp/commons/sams/arrow_bullet.gif" border="0" height="21" width="22"> <FONT Face="Verdana" color=#999999 size=4>Study Abroad</FONT><FONT size=4> <FONT size=3>»</FONT> <FONT color=#004898>UTA Study Abroad Programs 
       </FONT></FONT></P>
              </td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr>
                                <td bgcolor="#999999" class="formtable">Region  </td>
				<td bgcolor="#999999" class="formtable">Country </td>
			...
			<tr>
				<td align="left" valign="top">
                	<select style="width:160px" id="regionSelect" name="region" onchange="updateCountry()" multiple size="8"><option>---Regions-----</option></select></td>
            
                        
                <td align="left" valign="top">
                <select style="width:160px" id="countrySelect" name="country" multiple size="8"></select></td>
            ...
            <tr><td>&nbsp;</td></tr>
                <tr>
                    <td bgcolor="#999999" class="formtable">School  </td>
                    <td bgcolor="#999999" class="formtable">Department</td>
					<td bgcolor="#999999"></td>
                    
                </tr>  
				<tr><td>&nbsp;</td></tr>
                <tr>
                    <td align="left" valign="top"><select  style="width:160px" id="schoolSelect" name="school"onchange="updateDepartment()" multiple size="8"><option>---Schools-----</option></select></td>
                  <td align="left" valign="top" ><select  style="width:160px" id="departmentSelect" name="subjects" multiple size="8"></select></td>
...
<tr><td>&nbsp;</td></tr>
            <tr>
			<td bgcolor="#999999" class="formtable">Program Type </td>
			<td bgcolor="#999999" class="formtable">Term of Study</td>
                <td bgcolor="#999999" class="formtables">Languages </td>
				
            </tr>
			<tr><td>&nbsp;</td></tr>
            <tr>
			   <td align="left" valign="top">
					<select class="regionSelect" style="width:160px" name="programType" multiple size="3">
                    <option>Affiliated</option>
                    <option>Reciprocal Exchange</option>
                    <option>Faculty-led</option>
                </select></td>
			   <td align="left" valign="top"><select class="regionSelect" style="width:160px" name="term" multiple size="3">
